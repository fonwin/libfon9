...
fon9::seed::LayoutSP SymbIn::MakeLayout(fon9::seed::TreeFlag flags) {
   ...
   return LayoutSP{new LayoutN(fon9_MakeField(Symb, SymbId_, "Id"), flags,
      ...
      TabSP{new Tab{fon9::Named{"BS"},   fon9::fmkt::SymbTwaBS_MakeFields(true),   TabFlag::NoSapling_NoSeedCommand_Writable}},
      TabSP{new Tab{fon9::Named{"Deal"}, fon9::fmkt::SymbTwaDeal_MakeFields(true), TabFlag::NoSapling_NoSeedCommand_Writable}}
   )};
}
