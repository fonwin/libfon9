...
fon9::seed::LayoutSP SymbIn::MakeLayout(fon9::seed::TreeFlag flags) {
   ...
   return LayoutSP{new LayoutN(fon9_MakeField(fon9::Named{"Id"}, Symb, SymbId_), flags,
      TabSP{new Tab{fon9::Named{"Base"}, fon9::fmkt::Symb::MakeFields(),     TabFlag::NoSapling_NoSeedCommand_Writable}},
      TabSP{new Tab{fon9::Named{"Ref"},  fon9::fmkt::SymbRef::MakeFields(),  TabFlag::NoSapling_NoSeedCommand_Writable}},
      TabSP{new Tab{fon9::Named{"BS"},   fon9::fmkt::SymbBS::MakeFields(),   TabFlag::NoSapling_NoSeedCommand_Writable}},
      TabSP{new Tab{fon9::Named{"Deal"}, fon9::fmkt::SymbDeal::MakeFields(), TabFlag::NoSapling_NoSeedCommand_Writable}}
   )};
}
