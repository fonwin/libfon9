...
public:
   ...
   typedef value_type (*FnValueMaker)(const fon9::StrView& idstr, OmsIvBase* owner);
   const FnValueMaker   FnValueMaker_;
   const OmsIvBaseSP    ContainerOwner_;
   SvctSet&             Container_;

   OmsTreeSvctSet(OmsCore& omsCore, fon9::seed::LayoutSP layout, OmsIvBaseSP owner, SvctSet& container, FnValueMaker fnValueMaker)
