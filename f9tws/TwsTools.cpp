...
void TwsSymbKindLvPriStep::Setup(StkNo stkno) {
   ...
   // -------------------------------------
   if (hdr2 == 0) {
      // 受益憑證 (封閉式基金)　　　 000101-003999　　　　　(註3)
      if (stkno.Chars_[2] <= '3') {
         this->Kind_ = f9tws_SymbKind_BC;
         return;
      }
      // ETF　　　　　　　　　　　　 00400-00999+第六碼9
      // ETF(外幣計價）　　　　　　　00400-00999+第六碼K
      // 債券ETF　　　　　　　　　　 00400-00999+第六碼B
      // 債券ETF(外幣計價）　　　　　00400-00999+第六碼C
      // 槓桿型ETF　　　　　　　　　 00400-00999+第六碼L
      // 槓桿型ETF(外幣計價）　　　　00400-00999+第六碼M
      // 反向型ETF　　　　　　　　　 00400-00999+第六碼R
      // 反向型ETF(外幣計價）　　　　00400-00999+第六碼S
      // 期信託ETF　　　　　　　　　 00400-00999+第六碼U
      // 期信託ETF(外幣計價）　　　　00400-00999+第六碼V
      this->LvPriSteps_ = LvPriSteps_ETF;
      switch (ch6) {
      default:
