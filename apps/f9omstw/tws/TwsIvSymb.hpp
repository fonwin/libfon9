// \file tws/TwsIvSymb.hpp
//
// 台股帳號(子帳、母帳)的各商品風控資料(庫存量、委託量、成交量...).
//
// \author fonwinz@gmail.com
#ifndef __f9omstw_tws_TwsIvSymb_hpp__
#define __f9omstw_tws_TwsIvSymb_hpp__
...
/// 證券帳號商品風控: 庫存、今日委託量...
/// 子帳、母帳使用相同的風控資料結構.
class TwsIvSymb : public OmsIvSymb {
   fon9_NON_COPY_NON_MOVE(TwsIvSymb);
   struct PodOp;
...
#endif//__f9omstw_tws_TwsIvSymb_hpp__
